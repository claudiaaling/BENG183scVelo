...
In a 2020 study, Bergen et al. applied scVelo to scRNA-seq data from mouse tissues to test whether the dynamical model could reconstruct known developmental trajectories. 
